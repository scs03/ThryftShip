  ...
  return (
    <div className='min-h-screen flex justify-center items-center'>
        <div className='flex flex-col items-center w-1/2  p-8 rounded-lg'>
            ...
            <img className='mt-4 w-36' src="./assets/cubeLogo.svg" alt="Flying Package" />
        ...
        <div className='absolute bottom-4 md:right-4 flex flex-col '>
            <img className='mt-4 w-12 opacity-0 md:opacity-100' src="./assets/cubeLogo.svg" alt="Flying Package" />
